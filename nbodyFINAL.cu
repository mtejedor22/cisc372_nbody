...
void initialize_cuda_variables(int NUMENTITIES) {
...
void copy_data_to_device(int NUMENTITIES) {
...
int main(int argc, char **argv)
{
	...
	printSystem(stdout);
	#endif
	initialize_cuda_variables(NUMENTITIES);
	copy_data_to_device(NUMENTITIES);
